...
@section('contenido')
    <div class="container-fluid col-md-12 p-2 bg-white">
        ...
        <div class="container-fluid row col-md-12 border-bottom p-2">
            ...
            <div class="col-md-3">
                @can('agregar-permiso')
                    <x-adminlte-button label=" permiso" theme="primary" data-toggle="modal" data-target="#modalNuevo" icon="fas fa-plus-circle"></x-adminlte-button>
                @endcan
                            ...
                            @foreach($permisos as $permiso)
                                @can('ver-permiso')
                                    <tr>
                                        ...
                                        <td>
                                            @can('editar-permiso')
                                                <x-adminlte-button class="editar" id="editar"  theme="info" data-toggle="modal" data-target="#modalEditar" data-id="{{ $permiso->id }}" icon="fas fa-edit"></x-adminlte-button>
                                            @endcan
                                            @can('borrar-permiso')
                                                <x-adminlte-button class="eliminar" id="eliminar"  theme="danger" data-id="{{ $permiso->id }}" icon="fas fa-trash-alt" data-value="{{ $permiso->name }}"></x-adminlte-button>
                                            @endcan
                                        </td>
                                    </tr>
                                @endcan
