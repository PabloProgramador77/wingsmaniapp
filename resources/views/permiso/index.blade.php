                                ...
                                @can('ver-permiso')
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @endcan
                                            @can('borrar-permiso')
                                                <x-adminlte-button class="eliminar" id="eliminar" label="Borrar" theme="danger" data-id="{{ $permiso->id }}" icon="fas fa-trash-alt" data-value="{{ $permiso->name }}"></x-adminlte-button>
                                            @endcan
                                        </td>
                                    </tr>
                                @endcan
