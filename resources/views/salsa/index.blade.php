                                ...
                                @can('ver-salsa')
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @endcan
                                            @can('borrar-salsa')
                                                <x-adminlte-button class="eliminar" id="eliminar" label="Borrar" theme="danger" data-id="{{ $salsa->id }}" icon="fas fa-trash-alt" data-value="{{ $salsa->nombre }}"></x-adminlte-button>
                                            @endcan
                                        </td>
                                    </tr>
                                @endcan
