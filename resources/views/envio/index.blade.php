...
@section('contenido')
    <div class="container-fluid col-md-12 p-2 bg-white">
        ...
        <div class="container-fluid row col-md-12 border-bottom p-2">
            ...
            <div class="col-md-3">
                @can('agregar-envio')
                    <x-adminlte-button label=" envio" theme="primary" data-toggle="modal" data-target="#modalNuevo" icon="fas fa-plus-circle"></x-adminlte-button>
                @endcan
                            ...
                            @foreach($envios as $envio)
                                @can('ver-envio')
                                    <tr>
                                        ...
                                        <td>
                                            @can('editar-envio')
                                                <x-adminlte-button class="editar" id="editar"  theme="info" data-toggle="modal" data-target="#modalEditar" data-id="{{ $envio->id }}" icon="fas fa-edit"></x-adminlte-button>
                                            @endcan
                                            @can('borrar-envio')
                                                <x-adminlte-button class="eliminar" id="eliminar"  theme="danger" data-id="{{ $envio->id }}" icon="fas fa-trash-alt" data-value="{{ $envio->nombre }}"></x-adminlte-button>
                                            @endcan
                                        </td>
                                    </tr>
                                @endcan
